...
tags: 
    ...
    - "css"
    - "javascript"
description: "Web fundamentals: HTML, CSS, and JavaScript basics for building modern web pages"
---

---
layout: title
title: Web 二三事
subtitle: Lecture 1 - 网页妙啊妙
---
...
<div className="grid grid-cols-2 gap-3">
  <CodeBlockWithHeader code={code} lang="html" header="HTML" filename="index.html" className="text-xl" />
...
export const code = `<tagname attr1="val1" attr2="val2">
  <!-- content 
  goes 
  here -->
</tagname>`

<CodeBlockCode code={code} lang="html" className="text-xl" />
