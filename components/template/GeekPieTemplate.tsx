                  ...
                  <main className="w-full h-full flex flex-col overflow-auto p-12">
                    {slide.layout === "title" ? (
                      ...
                      <div className="flex flex-col gap-3 justify-center items-start">
                        {slide.content && slide.title && <h2 className="text-4xl font-bold">{slide.title}</h2>}
                        {slide.content && slide.subtitle && <h3 className="text-3xl text-muted-foreground">{slide.subtitle}</h3>}
